export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Inter:wght@350;400;650;700&family=Poppins:ital,wght@1,800&display=swap' },
      { rel: 'preload', as: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Inter:wght@350;400;650;700&family=Poppins:ital,wght@1,800&display=swap' }
    ]
  },
